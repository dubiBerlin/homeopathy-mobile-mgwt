...
import de.mgwt.dubravko.client.seite4.ViewCell4;


public class SeiteViewImpl6 implements SeiteView6{

	private LayoutPanel mainPanel;
	private CellList<Heilmittel> cellList;
	private HeaderButton headerBackButton;
	
	public SeiteViewImpl6() {
		mainPanel = new LayoutPanel();
		HeaderPanel headerPanel = new HeaderPanel();
		headerPanel.setCenter("Hom&ouml;opathische App - Gnielka & El-Kabarity");
